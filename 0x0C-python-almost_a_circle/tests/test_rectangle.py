...
class TestRectangle(unittest.TestCase):
    ...
    def test_str_no_id(self):
        ...
        self.assertEqual("[Rectangle] (22) 8/9 - 5/7", str(rect))
    ...
    def test_update_with_empty_args(self):
        rect = Rectangle(10, 10, 10, 10)
        rect.update()
        self.assertEqual("[Rectangle] (27) 10/10 - 10/10", str(rect))
    ...
    def test_to_dictionary_with_no_id_specified(self):
        ...
        self.assertEqual({"id": 23, "width": 13, "height": 3, "x": 10,
                          "y": 10}, rep)

    def test_to_dictionary_with_only_width_height_specified(self):
        rect = Rectangle(12, 2)
        rep = rect.to_dictionary()
        self.assertEqual({"id": 24, "width": 12, "height": 2, "x": 0,
                          "y": 0}, rep)
